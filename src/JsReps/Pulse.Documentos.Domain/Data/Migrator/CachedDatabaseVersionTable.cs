...
namespace Pulse.Documentos.Domain.Data.Migrator {
    public class CachedDatabaseVersionTable {
        ...
        public string IfExistsCurrentVersionQuery => _versionTable.IfExistsCurrentVersionQuery;
        ...
        public void SetCurrentVersion(string database, long version) {
            _cache[database] = version;
        }
